Game.Actor = new Game.Class({
	...
	move_up : function(id){
		this.move(0,-(this.physics.speed));
		if(this.sprite.type == 'sprite'){
			if(this.sprite.positions.hasOwnProperty('up')){
				this.sprite.sprite_pos = this.sprite.positions.up;
			}
		}
		this.remove_from_on(id);
	},
	move_down : function(id){
		this.move(0,this.physics.speed);
		if(this.sprite.type == 'sprite'){
			if(this.sprite.positions.hasOwnProperty('down')){
				this.sprite.sprite_pos = this.sprite.positions.down;
			}
		}
		this.remove_from_on(id);
	},
